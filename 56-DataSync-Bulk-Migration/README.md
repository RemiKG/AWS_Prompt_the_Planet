...
The real numbers are unforgiving. A 40 TB NAS over a 500 Mbps office link at 80% utilization is ~9.3 days of *continuous* transfer at the theoretical line-rate floor—call it ~11–12 days once you derate for protocol overhead and small-file penalty—and that link is shared with payroll, video calls, and the CEO's demo. Do it wrong and you get all three classic failures at once: a saturated uplink during business hours, a non-resumable copy that restarts from zero after every blip, and a "migration complete" declaration backed by nothing but hope.
